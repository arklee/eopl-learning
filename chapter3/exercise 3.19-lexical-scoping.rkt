  ...
  (lambda (exp env)
    (cases expression exp
      ...
      (letproc-exp
       ...
       (let [(proc1 (letproc-val var proc-var proc-body env))]
      ...
      (apply-exp
       ...
       (let [(proc1 (value-of exp1 env))
         ...
         (cases expval proc1
           ...
           (letproc-val
            (proc-name var body saved-env)
            (value-of body (extend-env var val1 (extend-env proc-name (letproc-val proc-name var body saved-env) env))))
